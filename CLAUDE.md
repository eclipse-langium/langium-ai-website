...
- Canonical code repo is `eclipse-langium/langium-ai` — site links, edit-this-page, and
  the CHANGELOG link out there. The `langium-minilogo` fixture lives at `langium/langium-minilogo`.
